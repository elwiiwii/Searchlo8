...
namespace Searchlo8
{
    public class Cyclo8 : ICart
    {
	    ...
	    private void UpStepEntity(EntityClass ent)
        {
            ...
            if (ent.Y > F32.FromDouble(160.1)) //F32.FromDouble(16.9132))
            {
...

